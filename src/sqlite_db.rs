...
// pub fn init_db (trigger_word_list: &mut Vec<String>) -> Result<&Connection, String> {
//     // _ouvre la db
//     let connection_db =
...
//                    match connection_db_ctrl.prepare("CREATE TABLE if not exists talking (chat_id INTEGER PRIMARY KEY, trigger TEXT not null, answer TEXT not null);") {
...
//                    match connection_db_ctrl.prepare("SELECT trigger FROM talking") {
...
//            }
//            Err(e) => {
//                return Err(format!("ERROR: opening database - {}", e))
//            }
//         };
//
//     Ok(connection_db)
